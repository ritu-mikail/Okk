...
module.exports.run = async ({ event, api, args, Threads, handleReply, Users }) => {
  ...
  const cre = this.config.credits
      ...
      api.sendMessage(`[ OK ] Your group has been removed from the browsing list by the admin for the reason: ${lydo}`, idBox);
   	...
   	else api.sendMessage("আসসালামু আলাইকুম \nআপনার গ্রুপ বা ইনবক্সে এডমিন Approval করে দিয়েছে\nআসা করি  কেউ বট  বাজে কাছে ব্যাবহার করবেন না যে কোন সমস্যা জন্য  এডমিন কে মেসেজ করতে পারো\n\nhttps://m.me/ji.la.pi.2\n===== 𝐍𝐀𝐙𝐑𝐔𝐋 𝐁𝐎𝐓 =====", idBox, (error, info) => {
