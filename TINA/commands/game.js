...
if(!fs.existsSync(__dirname+'/Nazrul/bold-font.ttf')) {
...
fs.writeFileSync(__dirname+'/Nazrul/bold-font.ttf', Buffer.from(getfont, "utf-8"));

};

Canvas.registerFont(__dirname+'/Nazrul/bold-font.ttf', {
